...
public class Calculator
{
	...
	public void announceStatus()
	{
		if (lunchStatus == FREE)
		{
			...
			alert.setContentText("Student lunch status is Free. Please put a (2) in the lunch status field");
		...
		else if (lunchStatus == REDUCE)
		{
			...
			alert.setTitle("Lunch Status");
			alert.setHeaderText("Student Lunch Status");
			alert.setContentText("Student lunch status is Reduced. Please put a (3) in the lunch status field");
		...
		else if (lunchStatus == PAID)
		{
			...
			alert.setTitle("Lunch Status");
			alert.setHeaderText("Student Lunch Status");
			alert.setContentText("Student lunch status is Paid. Please put a (4) in the lunch status field");
	...
	{
		int totalIncome;
		totalIncome = calculateMonthlyIncome() + calculateBimonthlyIncome() + calculateBimonthlyIncome() + calculateWeeklyIncome() + yearlyIncome;
		return totalIncome;
	}
	...
	{
		int incomeLimitFree = 0;
		int incomeLimitReduce = 0;
